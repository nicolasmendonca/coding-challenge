...
export const ShopBlueIcon = ( { primaryColor } ) => (
	<svg className="ShopBlueIcon" width="42px" height="42px" viewBox="0 0 42 42" version="1.1" xmlns="http://www.w3.org/2000/svg">
		<title>Icon</title>
		...
		<defs>
			<radialGradient cx="50%" cy="50.8764901%" fx="50%" fy="50.8764901%" r="79.8469947%" id="radialGradient-1">
				...
				<stop stopColor={primaryColor} offset="100%"></stop>
			</radialGradient>
		</defs>
